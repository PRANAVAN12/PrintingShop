...
{	
	...
	if(empty($categary) || empty($quantity) || empty($description)) {	
		...
		//redirectig to the display page. In our case, it is Payment
		header("Location: ../Purchase/add.html");
	}
}
?>
<?php
...
<body class="form-v9">
	<div class="page-content">
		<div class="form-v9-content" style="background-image: url('../frm/images/form-v9.jpg')">
			<form class="form-detail" name="form1" method="post" action="UserOrder.php">
				<h2>Updated Customer Request from Admin</h2>
				...
				<div class="form-row-last">
					...
					<input type="submit"  class="register" name="Pay" value="Pay">
				</div>
			</form>
		</div>
	</div>
